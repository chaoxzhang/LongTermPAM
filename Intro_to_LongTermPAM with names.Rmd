...
"<https://github.com/chaoxzhang/LongTermPAM/tree/main/vignettes/>".
...
"<https://github.com/chaoxzhang/LongTermPAM/tree/main/inst/extdata>".
...
arguments can be found in R help page and in the paper Zhang et al.,
...
(2) quantum yield parameters: $\Phi$P [or Y(II)], $\Phi$NPQ~T~,
    $\Phi$f,D, and $\Phi$NPQr . Please see calculation method and
    parameter description in Porcar-Castell et al. 2011 and Zhang et
    al.XX
...
(2) quantum yield parameters: F~V~/F~M~, $\Phi$NPQ~S~, and $\Phi$f,D~S~.
    Please see calculation method and parameter description in
    Porcar-Castell et al. 2011 and Zhang et al.XX
