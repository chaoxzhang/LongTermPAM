...
#' @param f4.Fm the threshold of percentage change of Fm between consecutive days. Default value is 0.15, we recommend this argument can be adjusted from 0.05 to 0.3 by an interval of 0.05.
#' @param f4.FmYII the threshold of ratio between percentage change in Fm between consecutive days and in Fv/Fm between consecutive days. Default value is 3, we recommend this argument can be adjust between 2 and 5 by an interval of 1.
#'
